            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="post" action="{{ route('chirps.store') }}">
                        @csrf
                        <label>
                            <textarea name="body" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full"
                ...
                @foreach($chirps as $chirp)
                    <div class="p-6 flex space-x-2">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-4 text-lg text-gray-900 dark:text-gray-100">{{ $chirp->body }}</p>
                        </div>
                        @can('update', $chirp)
                            <x-dropdown>
                                <x-slot name="trigger">
